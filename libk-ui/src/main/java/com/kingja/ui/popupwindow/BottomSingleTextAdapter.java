 ...
 * 修改备注：
 */
public class BottomSingleTextAdapter extends BaseSimpleAdapter<String> {
    public BottomSingleTextAdapter(Context context, List<String> list) {
        super(context, list);
    }
    ...
    public View simpleGetView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View
                    .inflate(context, R.layout.item_bottom_single_text, null);
